...
export const siteConfig: SiteConfig = {
  ...
  siteURL: "https://yazawa-sunrise.com/", // 请替换为你的站点URL，以斜杠结尾
  ...
  bangumi: {
    userId: "yazawasunrise", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
    fetchOnDev: true, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
  },

  bilibili: {
    vmid: "32883655", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
  ...
  font: {
    ...
    asciiFont: {
      ...
      fontWeight: "400",
      localFonts: ["SourceHanSansSC-Medium.ttf"],
